    ...
    if (mysqli_num_rows($admin) === 1) {
        ...
        if ($password == $row["password"]) {
            ...
            echo "<script>
                ...
                header("Location:tes2-backgroundresp.html");
                exit;
        }
    } 
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row["password"])) {
            ...
            echo "<script>
                ...
                header("Location:tes2-backgroundresp.php");
                exit;
        }
    } 
...
<body>
  ...
  <form action="" method="post">
    <h3 style="text-align: center; margin-top: 80px; font-family:arial; color: #fff; font-size: 32px;">LOGIN</h3>
      <table border="0" cellpadding="10" cellspacing="0">
        ...
        <tr><th colspan="2"><button type="submit" name="login" id="login">LOGIN
        ...
        <tr>
        <td><label class="inginregist" style="text-align: center; font-size: 12px; font-family: arial; color: white; font-size: 16px;">Belum Punya Akun ? <a style="font-family: arial; font-size: 14px; color: white" href="registrasi.php">  Buat Akun</a></label></td>
        </tr>
      </table>
  </form>
  </div>
  ...
  <div class="kembali">
        <a href="tes2-backgroundresp.php"><button id="kembali" title="kembali" name="kembali" class="div-kembali"><img src="img/previous.png" alt="kembali" class="icon-kembali"></button></a>
    </div>
